...
const Base = () => {
    ...
    return (
        <div className={close ? `flex min-h-[650px] ml-10 mr-10 border-b-2 border-gray-500` : `flex flex-col h-[45vh] ml-6 mr-6 border-b-2 border-gray-500`}>
            <div className={close ? `w-2/5 absolute left-0 bottom-[4%] text-left`:`w-[85%] absolute left-0 bottom-[48%] text-left`}>
                <h2 className={close ? `text-[38px] pl-10 font-semibold leading-tight`:`text-[24px] w-full pl-10 font-semibold leading-[1]`}>
