...
const Page3 = () => {
  ...
  return (
    <div className='w-full h-[120vh] flex items-center bg-[#EFEAE3] justify-center'>
      <div className="w-[95%] h-[105vh] bg-black rounded-3xl flex items-center">
        <div className="w-1/2 h-2/3 flex flex-col items-center">
          <div className="w-[60%] h-[60%]">
            <div className="w-full flex">
              <div className={sele === "Design" ? "w-[1%] bg-orange-500 mr-4 rounded-t-sm" : "w-[1%] bg-gray-500 mr-4" }></div>
              <h1 className={sele === "Design" ? "w-[90%] text-8xl text-white font-bold capitalize cursor-pointer" : "w-[90%] text-8xl text-gray-500 font-bold capitalize cursor-pointer"} onClick={()=> handleClick("Design")}>Design</h1>
            </div>
            <div className="w-full flex">
              <div className={sele === "Project" ? "w-[1%] bg-orange-500 mr-4 rounded-t-sm ease-in-out" : "w-[1%] bg-gray-500 mr-4 ease-in-out" }></div>
              <h1 className={sele === "Project" ? "w-[90%] text-8xl text-white font-bold capitalize cursor-pointer" : "w-[90%] text-8xl text-gray-500 font-bold capitalize cursor-pointer"} onClick={()=>handleClick("Project")}>Project</h1>
            </div>
            <div className="w-full flex">
              <div className={sele === "Execution" ? "w-[1%] bg-orange-500 mr-4 rounded-t-sm ease-in-out" : "w-[1%] bg-gray-500 mr-4 ease-in-out" }></div>
              <h1 className={sele === "Execution" ? "w-[90%] text-8xl text-white font-bold capitalize cursor-pointer" : "w-[90%] text-8xl text-gray-500 font-bold capitalize cursor-pointer"} onClick={()=>handleClick("Execution")}>Execution</h1>
            </div>
          </div>
          <div className="w-[60%] h-[20%] text-[#EFEAE3] text-lg leading-tight">
              {desc}
            </div>
        </div>
